"""Create Module page — layout aligned with Create Organization."""
...
class CreateModulePage(QWidget):
    """Page with form to create a new module (same shell as Create Organization)."""
