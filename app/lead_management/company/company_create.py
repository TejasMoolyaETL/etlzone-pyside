...
class CreateCompanyPage(QWidget):
    def __init__(
        self,
    ...
    def _build_ui(self) -> None:
        ...
        hl.addWidget(QLabel("Create Company"))
        hl.addStretch()
    ...
    def _handle_create(self) -> None:
        if not self._can_create_company:
            self._show_error("Create disabled: missing step access lead-company-create.")
            return
        self._clear_error()
        ...
        result = api_create_lead_company(payload, token=self._token())
