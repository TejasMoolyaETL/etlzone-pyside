...
class DmContactPersonCompanyAssignmentListPage(QWidget):
    def __init__(
        self,
    ...
    def _build_ui(self) -> None:
        ...
        hl.addWidget(QLabel("DM: Company Contact Assignment"))
        hl.addStretch()
    ...
    def _refresh_action_access(self) -> None:
        ...
        if steps is None:
            ...
            lbl = "DM: Company Contact Assignment"
    ...
    def _show_assignment_context_menu(self, contact_row: dict[str, Any] | None, global_pos: QPoint) -> None:
        ...
        if act == add:
            ...
            if (
                ...
                return
            res = api_delete_dm_contact_person_company_assignment(rid, token=self._token())
