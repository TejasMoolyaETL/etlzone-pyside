...
from core.api import (
    ...
    api_update_dm_contact_person_company_assignment,
)
...
class ViewDmContactPersonCompanyAssignmentPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        hl.addWidget(QLabel("DM: Company Contact Assignment Details"))
        hl.addStretch()
    ...
    def _refresh_edit_action_access(self) -> None:
        ...
        if steps is None:
            ...
            self._can_edit_action = nav_action_visible(
                "DM: Company Contact Assignment", "edit", allowed
            )
    ...
    def _handle_edit(self) -> None:
        if not self._can_edit_action:
            self._show_error(
                "Edit disabled: missing step access dm-company-contact-assignment-edit."
            )
            return
        if self._company_combo is not None:
            self._company_combo.setEnabled(False)
    ...
    def _handle_save(self) -> None:
        ...
        res = api_update_dm_contact_person_company_assignment(aid, payload, token=self._token())
