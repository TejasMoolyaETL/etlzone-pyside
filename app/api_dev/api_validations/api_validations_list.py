"""API Validations list — same layout and behavior as API: Details list."""
...
# List table omits Project Id (full row on UserRole for open/edit).
...
class APIValidationsPage(QWidget):
    """API → API: Validations — matches API: Details list UX."""
