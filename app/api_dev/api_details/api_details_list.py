"""API Details list — same layout and behavior as API: Validations list."""
...
# API: Details list table only — omits Project Id (full row still on UserRole for open/edit).
...
class APIDetailsPage(QWidget):
    """API → API: Details — matches API: Validations list UX (compact table + column filters)."""
