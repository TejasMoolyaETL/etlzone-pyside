...
class CreateCategoryPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        header_layout.addWidget(QLabel("Create Category"))
        ...
        create_btn = QPushButton("Create Category")
    ...
    def is_dirty(self) -> bool:
        return bool(self.category_name_edit.text().strip())
    ...
    def _handle_create(self) -> None:
        ...
        result = api_create_category(name, token=token)
